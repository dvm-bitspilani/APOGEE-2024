...
export default function Decors({
  ...
  const smokeDroneMat = new smokeDroneMaterial({
    uColor: new Color("#ffeeee"),
    side: DoubleSide,
  });
  ...
  useFrame((state, delta) => {
    ...
    camera1.current.lookAt(
      new Vector3(
        robot.current.position.x,
        robot.current.position.y,
        robot.current.position.z,
      ),
    );
    camera2.current.lookAt(
      new Vector3(
        robot.current.position.x,
        robot.current.position.y,
        robot.current.position.z,
  ...
  return (
    <>
      ...
      <mesh
        geometry={nodes.baseLab.geometry}
        material={baseMaterial}
        matrixAutoUpdate={false}
      >
        <Decals
          incubatorReact={incubatorReact}
          incubatorThree={incubatorThree}
          project1Gsap={project1Gsap}
          project1Three={project1Three}
          project2Three={project2Three}
          project2Blender={project2Blender}
          project3Three={project3Three}
          project3Rapier={project3Rapier}
          project3Blender={project3Blender}
          project4Three={project4Three}
          project4React={project4React}
          project4Gsap={project4Gsap}
          project4Blender={project4Blender}
          project5Three={project5Three}
          project5React={project5React}
          project5Gsap={project5Gsap}
          project5Blender={project5Blender}
        />
      </mesh>
      <mesh
      ...
      />
      <mesh
        geometry={nodes.blueBloom.geometry}
        material={bloomBlueMaterial}
        matrixAutoUpdate={false}
      />
      <mesh
        geometry={nodes.whiteBloom.geometry}
        material={whiteBloomMaterial}
        matrixAutoUpdate={false}
      />
      <mesh
        geometry={nodes.blackFixed.geometry}
        material={blackMaterial}
        matrixAutoUpdate={false}
      />
      <mesh
        ref={handCircleRotate}
        geometry={nodes.handCircleRotate.geometry}
        material={whiteBloomMaterial}
      ...
      <group position={[-2.19, -9.49, -197.59]}>
        <mesh
          onClick={mail}
          onPointerEnter={hoverEnterEvent}
          onPointerLeave={hoverLeaveEvent}
          geometry={nodes.logoContactMail.geometry}
        ...
        <mesh
          ...
          onPointerEnter={hoverEnterEvent}
          onPointerLeave={hoverLeaveEvent}
          geometry={nodes.logoContactGithub.geometry}
          material={robotMaterial}
        />
        <mesh
          onClick={twitter}
          onPointerEnter={hoverEnterEvent}
          onPointerLeave={hoverLeaveEvent}
          geometry={nodes.logoContactTwitter.geometry}
          material={robotMaterial}
          position-y={-3.38}
        />
        <mesh
          ...
          onPointerEnter={hoverEnterEvent}
          onPointerLeave={hoverLeaveEvent}
          geometry={nodes.logoContactLinkedin.geometry}
          material={robotMaterial}
          position-y={-5.19}
        />
      </group>
      ...
      <Float rotationIntensity={0} floatIntensity={2} speed={4}>
        ...
        />
        <mesh
          geometry={nodes.deviceStructure.geometry}
          material={robotMaterial}
      ...
      <group ref={elevator} position={[6.04216337, -1.95339799, -63.89643097]}>
        <mesh
          geometry={nodes.elevatorGlass.geometry}
          material={glassMaterial}
        />
        <mesh
          geometry={nodes.elevatorLogo.geometry}
          material={whiteBloomMaterial}
        />
      ...
      <group ref={robot} position={[6.03043985, -0.99305123, 9.59347057]}>
        <group ref={robotHead}>
          <mesh
            geometry={nodes.teteRobotWhite.geometry}
            material={robotMaterial}
          />
          <mesh
            geometry={nodes.teteRobotBlack.geometry}
            material={blackMaterial}
          />
        </group>
        <group ref={robotBall}>
          <mesh
            geometry={nodes.ballRobotWhite.geometry}
            material={robotMaterial}
          />
          <mesh
            geometry={nodes.ballRobotBlack.geometry}
            material={blackMaterial}
          />
        </group>
      </group>
      ...
      <group
        ref={parabolaFull}
        position={[-7.00131, -13.5445, -210.76]}
        rotation-y={Math.PI * 0.3}
      >
        <group ref={parabola}>
          <mesh geometry={nodes.parabole.geometry} material={alumMaterial} />
          <mesh
            geometry={nodes.parabole1.geometry}
            material={bloomBlueMaterial}
          />
        </group>
        <mesh
          geometry={nodes.parabole3.geometry}
          material={bloomBlueMaterial}
        />
        <mesh
          ref={gear}
      ...
      <mesh
        ref={antenne}
        position={[-6.94229, -13.8555, -218.314]}
      ...
      <group ref={camera1} position={[0.452413, 8.26443, -53.396]}>
        <mesh
          geometry={nodes.camera1White.geometry}
          material={baseMaterial}
        ...
        />
        <mesh
          geometry={nodes.camera1Black.geometry}
          material={blackMaterial}
          rotation-y={-Math.PI * 0.5}
        />
      </group>
      <group ref={camera2} position={[0.452413, -9.34806, -74.3881]}>
        <mesh
          geometry={nodes.camera2White.geometry}
          material={baseMaterial}
          rotation-y={-Math.PI * 0.5}
        />
        <mesh
        ...
        />
        <mesh
          geometry={nodes.camera2Black.geometry}
          material={blackMaterial}
          rotation-y={-Math.PI * 0.5}
        />
      </group>
      <group ref={camera3} position={[0.452413, -9.30464, -179.392]}>
        <mesh
          geometry={nodes.camera3White.geometry}
          material={baseMaterial}
          rotation-y={-Math.PI * 0.5}
        />
        <mesh
        ...
        />
        <mesh
          geometry={nodes.camera3Black.geometry}
          material={blackMaterial}
          rotation-y={-Math.PI * 0.5}
        />
      </group>
