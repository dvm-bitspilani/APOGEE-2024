...
export default function StickComputer({
  material,
  stick1,
  stick2,
  stick3,
  ...
  const stickComputer1 = useRef(),
    stickComputer2 = useRef(),
    stickComputer3 = useRef();
  ...
  const scaleStickComputer = () => {
    stickComputers.forEach((element) => {
      gsap.to(element.current.scale, { z: Math.random(), duration: 1.5 });
    });
