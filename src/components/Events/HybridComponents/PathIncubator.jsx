...
export default function PathIncubator({
  ...
  const pathAnimation = () => {
    ...
    tl.to(path1Ref.current.scale, { x: 1, duration: 0.5 });
    tl.to(path2Ref.current.scale, { z: 1, duration: 1.25 });
    tl.to(path3Ref.current.scale, { x: 1, duration: 0.5 }, 0.8);
    tl.to(path4Ref.current.scale, { x: 1, duration: 1.25 });
    tl.to(path5Ref.current.scale, { z: 1, duration: 0.5 });

    tl.to(path1Ref.current.scale, { x: 0, duration: 0.5 }, 2.2);
    tl.to(
      path1Ref.current.position,
      {
        x: path1Position.xOffset,
        y: path1Position.yOffset,
        duration: 0.5,
        onComplete: () => {
    ...
    tl.to(
      path2Ref.current.position,
      {
        z: path2Position.zOffset,
        duration: 1.25,
        onComplete: () => {
    ...
    tl.to(path3Ref.current.scale, { x: 0, duration: 0.5 }, 3);
    tl.to(
      path3Ref.current.position,
      {
        x: path3Position.xOffset,
        y: path3Position.yOffset,
        duration: 0.5,
        onComplete: () => {
    ...
    tl.to(
      path4Ref.current.position,
      {
        x: path4Position.xOffset,
        y: path4Position.yOffset,
        duration: 1.25,
        onComplete: () => {
    ...
    tl.to(path5Ref.current.scale, { z: 0, duration: 0.5 }, 5);
    tl.to(
      path5Ref.current.position,
      {
        z: path5Position.zOffset,
        duration: 0.5,
        onComplete: () => {
